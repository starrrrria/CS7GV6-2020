...
camera(cam)
{
    ...
    std::cout << "Press W,S,A,D move, F pick up/put down things, V change first/third person camera, press I check trashbin style, mouse rotate angle of view. " << std::endl;
}
...
void Player::test(){
    std::cout << modelNumber <<","<< pickNumber << std::endl;
}
