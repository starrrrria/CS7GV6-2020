...
static void key_callback(GLFWwindow *window,int key, int scancode, int action, int mods){
    ...
    if (glfwGetKey(window, GLFW_KEY_F) == GLFW_PRESS) { //pick things
...
//            players.test();
    ...
    if (glfwGetKey(window, GLFW_KEY_I) == GLFW_PRESS){ //check trashbin tips
        if (players.Position.x <= (-binPositions[0].x + 0.3f) && players.Position.x >= (-binPositions[0].x - 0.3f) && players.Position.z <= (-binPositions[0].z + 0.3f) && players.Position.z >= (-binPositions[0].z - 0.3f)) {
            players.display = 1;
            players.tip = 1;
        }
        else if(players.Position.x <= (-binPositions[1].x + 0.3f) && players.Position.x >= (-binPositions[1].x - 0.3f) && players.Position.z <= (-binPositions[1].z + 0.3f) && players.Position.z >= (-binPositions[1].z - 0.3f)){
            players.display = 1;
            players.tip = 2;
        }
        else if (players.Position.x <= (-binPositions[2].x + 0.3f) && players.Position.x >= (-binPositions[2].x - 0.3f) && players.Position.z <= (-binPositions[2].z + 0.3f) && players.Position.z >= (-binPositions[2].z - 0.3f)){
            players.display = 1;
            players.tip = 3;
        }
        else if(players.Position.x <= (-binPositions[3].x + 0.3f) && players.Position.x >= (-binPositions[3].x - 0.3f) && players.Position.z <= (-binPositions[3].z + 0.3f) && players.Position.z >= (-binPositions[3].z - 0.3f)){
            players.display = 1;
            players.tip = 4;
        }
...
int main(int argc,char* argv[])
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Garbage sorting game", NULL, NULL);
    if (window == NULL)
    {
...
//    Shader* PickShader = new Shader("/Users/buxin/Desktop/triangle/PickVertex.vert","/Users/buxin/Desktop/triangle/PickFragment.frag");
    ...
    Material* TableMaterial = new Material(TableShader,
                                        LoadImageToGPU("/Users/buxin/Downloads/Wall-Segment/Wall-Segment_specular.jpg", GL_RGBA, GL_RGBA, Shader::DIFFUSE+1),
                                        LoadImageToGPU("/Users/buxin/Downloads/Wall-Segment/Wall-Segment_texture.jpg", GL_RGBA, GL_RGBA, Shader::SPECULAR+1),
                                        vec3 (1.0f,1.0f,1.0f),
                                        32.0f);
//    Material* WallMaterial = new Material(WallShader,
//                                        LoadImageToGPU("/Users/buxin/Desktop/triangle/triangle/Structure/Structure/Wall-Window/TexturesCom_MarbleWhite0040_1_seamless_S.jpg", GL_RGBA, GL_RGBA, Shader::DIFFUSE),
...
//                                        32.0f);
    Material* TrashbinMaterial = new Material(TrashbinShader,
                                        LoadImageToGPU("/Users/buxin/Downloads/Trashbin/Trashbin_diffuse.png", GL_RGBA, GL_RGBA, Shader::DIFFUSE+2),
                                        LoadImageToGPU("/Users/buxin/Downloads/Trashbin/Trashbin_specular.png", GL_RGBA, GL_RGBA,Shader::SPECULAR+2),
...
//                                        LoadImageToGPU("/Users/buxin/Downloads/Trashbin/TrashbinYellow_basecolor.png", GL_RGBA, GL_RGBA, Shader::DIFFUSE),
...
//                                        LoadImageToGPU("/Users/buxin/Downloads/Trashbin/TrashbinRed_basecolor.png", GL_RGBA, GL_RGBA, Shader::DIFFUSE),
...
//                                        LoadImageToGPU("/Users/buxin/Downloads/Trashbin/TrashbinGreen_basecolor.png", GL_RGBA, GL_RGBA, Shader::DIFFUSE),
...
//                                        LoadImageToGPU("/Users/buxin/Downloads/Cat/Cat_diffuse.jpg", GL_RGBA, GL_RGBA, Shader::DIFFUSE),
//                                        LoadImageToGPU("/Users/buxin/Downloads/Cat/Cat_bump.jpg", GL_RGBA, GL_RGBA, 16),
//                                        vec3 (1.0f,1.0f,1.0f),
//                                        32.0f);
//    Material* BookMaterial = new Material(BookShader,
//                                        LoadImageToGPU("/Users/buxin/Downloads/book/1984-book_A.jpg", GL_RGBA, GL_RGBA, Shader::DIFFUSE),
//                                        LoadImageToGPU("/Users/buxin/Downloads/book/1984-book_C.jpg", GL_RGBA, GL_RGBA, 18),
//                                        vec3 (1.0f,1.0f,1.0f),
//                                        32.0f);
//    Material* CanMaterial = new Material(CanShader,
//                                        LoadImageToGPU("/Users/buxin/Downloads/Can/KuimiBeerCan_color.png", GL_RGBA, GL_RGBA, Shader::DIFFUSE),
...
//                                        LoadImageToGPU("/Users/buxin/Downloads/rose/wildtextures-leather-Campo-rose.jpg", GL_RGBA, GL_RGBA, Shader::DIFFUSE),
...
//                                        LoadImageToGPU("/Users/buxin/Downloads/fish/fish_texture.png", GL_RGBA, GL_RGBA, Shader::DIFFUSE),
//                                        LoadImageToGPU("/Users/buxin/Downloads/fish/fish_texture.png", GL_RGBA, GL_RGBA, 24),
//                                        vec3 (1.0f,1.0f,1.0f),
//                                        32.0f);
//    Material* CupMaterial = new Material(CupShader,
//                                        LoadImageToGPU("/Users/buxin/Downloads/coffee-cup/coffee_cup.jpg", GL_RGBA, GL_RGBA, Shader::DIFFUSE),
...
//                                        LoadImageToGPU("/Users/buxin/Downloads/pill-bottle/Pill-Bottle-Label-PSD-Template.jpg", GL_RGBA, GL_RGBA, Shader::DIFFUSE),
...
//                                        32.0f);
    ...
    Model FloorModel("/Users/buxin/Downloads/Wall-Segment/Wall-Segment.obj");
    Model WallModel("/Users/buxin/Downloads/Wall-Segment/Wall-Segment.obj");
    Model TrashbinModel("/Users/buxin/Downloads/Trashbin/Trashbin.obj");
    Model PlayerModel("/Users/buxin/Downloads/Cat/12221_Cat_v1_l3.obj");
...
//            glDrawArrays(GL_TRIANGLES, 0, 36); //从0开始，画三个顶点
        ...
        TableMaterial->shader->SetUniform1i("material.diffuse", Shader::DIFFUSE+1);
        TableMaterial->shader->SetUniform1i("material.specular", Shader::SPECULAR+1);
...
//        WallMaterial->shader->SetUniform1f("material.shininess", WallMaterial->shininess);
        ...
        for(int i = 0; i <4; i++){
            ...
            glUniform3f(glGetUniformLocation(WallShader->ID,"ambientColor"),0.2f,0.2f,0.2f);//环境光
...
//            WallMaterial->shader->SetUniform1i("material.specular", 6);
//            WallMaterial->shader->SetUniform1f("material.shininess", WallMaterial->shininess);
            WallModel.Draw(WallShader);
        }
        
        //Trashbin model
        for (int i = 0; i < 4; i++) {
            TrashbinModelMat = translate(mat4(1.0f), binPositions[i]);
            if (players.display == 1) {
                if (players.tip == 1) {
                    printf("This is recycle trash bin\n");
                }
                else if (players.tip == 2){
                    printf("This is other trash bin\n");
                }
                else if (players.tip == 3){
                    printf("This is harmful trash bin\n");
                }
                else if (players.tip == 4){
                    printf("This is kitchen trash bin\n");
                }
                players.display = 0;
            }
...
//            if (i == 0) {
            ...
            TrashbinMaterial->shader->SetUniform1i("material.diffuse", Shader::DIFFUSE+2);
            TrashbinMaterial->shader->SetUniform1i("material.specular", Shader::SPECULAR+2);
...
//                TrashbinModel.Draw(TrashbinShader);
//            }
//            else if (i ==2){
...
//            }
        ...
        //Player model
        PlayerModelMat = translate(mat4(1.0f), vec3(0.0f,-2.5f,0.0f));
        ...
        PlayerModelMat = rotate(PlayerModelMat, radians(-90.0f), vec3(1.0f,0.0f,0.0f));
//            PlayerModelMat = translate(PlayerModelMat, vec3(-camera.Position.x - (5*camera.Forward.x),camera.Position.y,-camera.Position.z-(5*camera.Forward.x)));
        ...
        PlayerModelMat = rotate(PlayerModelMat, -1.0f*camera.Forward.x, vec3(0,0.0f,1.0f));
        }
        else if(camera.Forward.z > 0){
            PlayerModelMat = rotate(PlayerModelMat, 1.0f*camera.Forward.x+ radians(180.0f), vec3(0,0.0f,1.0f));
        }
        players.GetPosition(vec3(-camera.firstPosition.x,camera.firstPosition.y,-camera.firstPosition.z));
        PlayerModelMat = scale(PlayerModelMat, vec3(0.025f,0.025f,0.025f));
...
//        CanMaterial->shader->SetUniform1f("material.shininess", CanMaterial->shininess);
        ...
        glUniform3f(glGetUniformLocation(RoseShader->ID,"ambientColor"),0.1f,0.1f,0.1f);//环境光
